...
public class NomisStaffUsersController {
    ...
    @Autowired
    public NomisStaffUsersController(final StaffUsersService userService) {
    ...
    public ResponseEntity<NomisStaffUser> getNomisStaffUser(@PathVariable("username") final String username) {
    ...
    public PagedResources<Resource<NomisStaffUser>> getNomisStaffUsers(final Pageable pageable) {
        ...
        final var staffUsers = staffUsersService.getStaffUsers(pageable);
