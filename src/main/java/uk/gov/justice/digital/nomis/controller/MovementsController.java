...
public class MovementsController {
    ...
    @Autowired
    public MovementsController(final MovementsService movementsService) {
    ...
    public PagedResources<Resource<ExternalMovement>> getMovements(final @ApiIgnore Pageable pageable,
        ...
        final var externalMovements = movementsService.getMovements(pageable, maybeFrom, maybeTo, maybeBookingId);
    ...
    public ResponseEntity<List<ExternalMovement>> getOffenderMovements(@PathVariable("offenderId") final Long offenderId,
